(function(){
    ...
    function app() {
        ...
        if (monthlyList.length > 0) {
            ...
            addChild({label: `Bu Hafta 36'dan Kalan`, value: `${rwthts} saat, ${rwtmts} dakika`, class: weekRemainingElem});
            addChild({label: `Bu Hafta 27'den Kalan`, value: `${rwthtwentys} saat, ${rwtmtwentys} dakika`, class: weekRemainingElem});
